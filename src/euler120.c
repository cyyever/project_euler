...
uint64_t rmax(uint64_t a) {
   ...
   * 	3.如果a%4==1，那么当数列超过a^a时，被warp成a 5a 9a ...的数列，接下来被wrap成4a开始的数列，接下来被warp成3a开始的数列，接下来被warp成2a开始的数列。在这四种数列中，最近的项是(a-1)*a
   * 	4.如果a%4==3，那么当数列超过a^a时，被warp成3a 7a 11a ...的数列，接下来被wrap成4a开始的数列，接下来被warp成a开始的数列，接下来被warp成2a开始的数列。在这四种数列中，最近的项是(a-1)*a
